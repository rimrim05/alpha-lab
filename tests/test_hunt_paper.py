...
def _fixture_panel():
    ...
    tickers = ["SPY", "QQQ", "IWM", "EFA", "EEM", "TLT", "IEF", "GLD", "SLV",
    ...
    fields["member"] = pd.DataFrame(1.0, index=dates, columns=tickers)
...
def test_registry_loads():
    assert set(BOOKS) == {"vol_managed_qqq", "vol_core_svxy", "trend_vol_qqq", "defensive_ensemble"}
    assert set(BOOKS.values()) <= {"qqq", "6040"}
